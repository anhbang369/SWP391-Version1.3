...
public class UserFakeList {
    ...
    public UserFakeList(String productID, String model, String brand, String type, int quantityInBill, int quantityInShipping, int receiptID, String inputDate, String status, int totalQuantity, String note, String accountantID, String stockKeeperID, String solution, int receiptDetailID) {
